Micro.UserProvided	=	{
		...
		setSideBarContent : function()
		{
			var html="";
				...
				html += "          <span class=\"icon\"><img src=\"\"><\/span>";
		...
		setMainContent : function()
		{
			var html="";
				...
				html += "            <div class=\"thumbnail\"><span class=\"photo type-2\"><img src=\"\" width=\"120\" height=\"102\" \/><\/span>";
				...
				html += "          <\/article>";
				html += "          <article class=\"need\">";
				html += "            <div class=\"thumbnail\"><span class=\"photo type-1\"><img src=\"\" width=\"120\" height=\"102\" \/><\/span>";
				html += "              <div class=\"status provide_pending\">";
				html += "                <ul>";
				html += "                  <li class=\"check-new\">New<\/li>";
				html += "                  <li class=\"check-share\">Share<\/li>";
